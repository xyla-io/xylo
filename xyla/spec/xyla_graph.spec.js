(function() {
  ...
  describe('render', function() {  
    ...
    it('should render a line graph', function(done) {
      let vectors = xyla.tools.transformVectors(
        xyla.bi.mode.dataVectors('test_data_set'),
        xyla.transformers.group.by(['s1', 's2']),
        xyla.transformers.group.distinct('n1'),
        xyla.transformers.aggregate.sum('n2')
      );
      let renderOptions = {
        elementOptions: {
          elementID: 'graph',
  ...
  describe('SumGraph', function() {  
    ...
    it('should render a line graph', function(done) {
      ...
      let graph = new xyla.SumGraph(vectors, ['s1', 's2'], 'n1', 'n2')
        .setGraphOptions({
          type: xyla.GraphType.line,
          xAxisOptions: {
            title: 'n1',
