(function () {
    ...
    describe('xyla', function () {
        ...
        it('should retrieve data sets', function () {
            ...
            expect(function () { return xyla.bi.mode.dataSet('non_existant_data_set'); }).toThrow();
        });
        it('should group rows in data sets', function () {
            var groups = xyla.bi.mode.groupedRows(xyla.bi.mode.dataSet('test_data_set'), ['s1', 's2']);
...
//# sourceMappingURL=xyla.spec.js.map