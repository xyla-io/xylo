...
(function () {
    ...
    xyla.Transformable = {
        ...
        transform: function () {
            ...
            this.dataVectors = (_a = xyla.tools).transformVectors.apply(_a, __spreadArrays([this.dataVectors], transformers));
            return this;
        },
    };
    /**
    ...
    xyla.Graph.prototype.leftJoinGraph = function (columns) {
        ...
        if (typeof columns === 'array') {
            columns.forEach(function (col) { return mapping[col] = col; });
        }
    ...
    xyla.Graph.prototype.addQuotientDimension = function (numeratorColumn, denominatorColumn) {
        this.transform(xyla.transformers.aggregate.sum(numeratorColumn), xyla.transformers.aggregate.sum(denominatorColumn), xyla.transformers.vector.quotient());
        return this;
    };
    /**
     ...
     */
    xyla.Graph.prototype.alignDataEnd = function (alignColumn) {
        var requiredColumnSets = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            requiredColumnSets[_i - 1] = arguments[_i];
        }
    ...
    xyla.MultiGraph.prototype.render = function () {
        var renderOptions = {
            elementOptions: this.elementOptions,
            graphs: this.graphs.map(function (g) {
                return {
