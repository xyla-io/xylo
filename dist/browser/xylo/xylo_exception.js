...
(function () {
    ...
    function XyloNoDataSetException(key) {
        var instance = new Error('No xylo.DataSet named ' + key + ' found in xylo.Model');
    ...
    function XyloPendingDataSetException(key) {
        var instance = new Error('The xylo.DataSet named ' + key + ' is not yet available.');
        Object.setPrototypeOf(instance, Object.getPrototypeOf(this));
        instance.key = key;
        return instance;
    }
...
//# sourceMappingURL=xylo_exception.js.map